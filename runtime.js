...
apache.createServer(function(req) {
    ...
    req.write('Boo')
    req.end()
    apache.process.log(apache.APLOG_NOTICE, req.headers_in.get('Host'))
    console.log(apache.APLOG_NOTICE, req.headers_in.get('Host'))
    console.log(apache.APLOG_NOTICE, req.headers_in.isEmpty())
    req.headers_out.set("Content-Type", "text/plain")
    console.log("req", req)
